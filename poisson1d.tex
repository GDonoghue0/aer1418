...
\item A piecewise linear finite element approximation space $\calV_h$ is a subspace of $\calV$ that is associated with a tessellation of $\Omega \subset \RR^1$ into segments.
